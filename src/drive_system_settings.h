...
//Encoder Processing
#define DRVSYS_PROCESS_ENCODERS_PERIOD_US 1000 //us -> 2kHz
#define DRVSYS_PROCESS_ENCODERS_FREQU 1000 //Hz
// Torque Target Control 
#define DRVSYS_CONTROL_TORQUE_PERIOD_US 400 // us 
#define DRVSYS_CONTROL_TORQUE_FREQU 2000 // Hz
// PID Controller
#define DRVSYS_CONTROL_POS_PERIOD_US 3333 //us 2000Hz
#define DRVSYS_CONTROL_POS_FREQ 300 //Hz
...
#define DRVSYS_LEARNING_PERIOD_MS 1
...
#define DRVSYS_KIN_KALMAN_MOTOR_ACCELERATION_STD 10000.0*DEG2RAD
#define DRVSYS_KIN_KALMAN_JOINT_ACCELERATION_STD 500*DEG2RAD
...
#define DRVSYS_TORQUE_CONTROL_BW 500
...
#define DRVSYS_VEL_PID_DEADBAND 0.10*DEG2RAD
#define DRVSYS_VEL_PID_INPUT_FILTER_ALPHA 0.1 // 200Hz/90 ~ 1Hz

#define DRVSYS_VEL_PID_INPUT_CUTOFF_FREQ 500
#define DRVSYS_POS_PID_INPUT_CUTOFF_FREQ 100

// PID Gains
#define PID_POS_GAIN_P 1.0
#define PID_POS_GAIN_I 0.0
#define PID_POS_GAIN_D 0.0

#define PID_VEL_GAIN_P 0.5
#define PID_VEL_GAIN_I 100
